     ...
     for(Currcode in countryList)
        {
             ...
             if(val.name === "f1" && Currcode ==="USD")
                {
                    newopt.selected = "selected";
                }
           else if(val.name === "t1" && Currcode ==="INR") newopt.selected = "selected";
...
{
    evt.preventDefault();
    let amt = document.querySelector("#a1");
    if(amt.value === "" || amt.value<=0) amt.value =1;
    ...
    try
    {
        ...
        alert(`${amt.value} of ${fromCurr.value} is Equals to ${res} ${toCurr.value}`);
